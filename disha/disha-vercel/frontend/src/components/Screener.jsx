...
const DEFAULT_FILTERS = {
  ...
  min_price:          '',
  max_price:          '',
  min_market_cap_cr:  0,     // Any
  min_pe:             '',
  max_pe:             '',    // Any
  min_revenue_growth: -9999, // Any
  trend:              'any', // Show all — filter after seeing results
}
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start gap-3 rounded-sm border border-gold/20 bg-gold/5 px-4 py-3">
        ...
        <p className="text-xs leading-relaxed text-muted">
          <span className="font-medium text-goldsoft">Smart defaults pre-applied</span> — Trend: Bullish (above 20-day avg) · All other filters open.
          Market Cap and P/E columns load live — apply those filters after results appear.
          Use Sector buttons to narrow down quickly. Adjust any filter freely.
        </p>
      </div>

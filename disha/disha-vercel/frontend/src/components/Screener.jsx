...
const DEFAULT_FILTERS = {
  ...
  min_price:          '',
  max_price:          '',
  min_market_cap_cr:  1000,   // > ₹1,000 Cr — mid-cap and above
  min_pe:             '',     // no min P/E — PSU banks often have P/E < 5
  max_pe:             30,     // exclude very overvalued stocks
  min_revenue_growth: -9999,  // Any — revenue data is often missing
  trend:              'any',     // no trend filter by default — market conditions vary
}
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start gap-3 rounded-sm border border-gold/20 bg-gold/5 px-4 py-3">
        ...
        <p className="text-xs leading-relaxed text-muted">
          <span className="font-medium text-goldsoft">Smart defaults pre-applied</span> — Market Cap &gt; ₹1,000 Cr · P/E max 30 · Any trend · Revenue growth open.
          These defaults find established, fairly-valued stocks. Add the Bullish trend filter
          when you want stocks with upward price momentum. Adjust any filter freely.
        </p>
      </div>
      ...
      <div className="rounded-sm border border-hairline bg-panel p-6">
        <p className="mb-5 text-xs uppercase tracking-wider text-muted">Filter Criteria
          <span className="ml-2 text-[10px] normal-case text-muted/60">— 219+ stocks across 17 sectors</span>
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <label className="mb-1.5 block text-xs font-medium text-ink/80">
              Market Cap
              <span className="ml-1 text-[10px] text-muted">(⭐ &gt;₹1,000 Cr)</span>
            </label>
        ...
        <div className="rounded-sm border border-hairline bg-panel">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-hairline px-5 py-3">
            <div>
              ...
              <span className="ml-2 text-xs text-muted">out of {results.universe} fetched</span>
            </div>

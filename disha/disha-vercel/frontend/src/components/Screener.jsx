    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start gap-3 rounded-sm border border-gold/20 bg-gold/5 px-4 py-3">
        ...
        <p className="text-xs leading-relaxed text-muted">
          <span className="font-medium text-goldsoft">Smart defaults pre-applied</span> — Showing top 50 blue-chip NSE stocks across all sectors by default.
          Select a specific sector to screen all stocks in that sector.
          Price and trend are live — click Run Screener to see results instantly.
        </p>
      </div>

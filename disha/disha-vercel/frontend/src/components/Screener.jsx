...
const DEFAULT_FILTERS = {
  ...
  trend:              'bullish', // above 50-day average
}
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start gap-3 rounded-sm border border-gold/20 bg-gold/5 px-4 py-3">
        ...
        <p className="text-xs leading-relaxed text-muted">
          <span className="font-medium text-goldsoft">Smart defaults pre-applied</span> — Market Cap &gt; ₹1,000 Cr · P/E max 30 · Bullish trend (above 50-day avg).
          Revenue growth left open since Yahoo often has missing data for that field.
          These defaults find established, fairly-valued stocks with upward momentum. Adjust freely.
        </p>
      </div>

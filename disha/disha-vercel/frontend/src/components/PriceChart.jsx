      ...
      <div className="h-64 w-full">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top:5,right:10,left:-10,bottom:0 }}>
            ...
            <XAxis dataKey="label" tick={{fill:'#8A93A6',fontSize:11,fontFamily:'JetBrains Mono'}} axisLine={{stroke:'#2A3B57'}} tickLine={false} minTickGap={20}/>
            <YAxis tick={{fill:'#8A93A6',fontSize:11,fontFamily:'JetBrains Mono'}} axisLine={false} tickLine={false} domain={['auto','auto']} width={50}/>
            <Tooltip contentStyle={{background:'#16243A',border:'1px solid #2A3B57',borderRadius:2,fontFamily:'JetBrains Mono',fontSize:12}} labelStyle={{color:'#8A93A6'}} itemStyle={{color:'#E8C97A'}} formatter={v => [`₹${v}`,'Close']}/>
